...
class MenteePostApi {
    ...
    func observePost(withId id: String, completion: @escaping (MenteeModel) -> Void) {
    ...
    func incrementLikes(postId: String, onSuccess: @escaping (MenteeModel) -> Void, onError: @escaping (_ errorMessage: String?) -> Void ) {
        
        let postRef = Api.MenteePost.REF_POSTS.child(postId)
