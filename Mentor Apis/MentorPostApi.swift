...
class MentorPostApi {
    ...
    func observePost(withId id: String, completion: @escaping (MentorModel) -> Void) {
    ...
    func incrementLikes(postId: String, onSuccess: @escaping (MentorModel) -> Void, onError: @escaping (_ errorMessage: String?) -> Void ) {
        
        let postRef = Api.MentorPost.REF_POSTS.child(postId)
